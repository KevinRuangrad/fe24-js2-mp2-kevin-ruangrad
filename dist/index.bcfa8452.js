 ...
 * 
*/ var _dummyjsonapiTs = require("./modules/dummyjsonapi.ts");
var _guiTs = require("./modules/gui.ts");
var _filteringTs = require("./modules/filtering.ts");
var _sortingTs = require("./modules/sorting.ts");
...
const loadProducts = async ()=>{
    try {
        products = await (0, _dummyjsonapiTs.getAllProducts)();
        (0, _guiTs.renderProducts)(products);
    } catch (error) {
        console.error(error);
    }
};
loadProducts();
/*** Filter using filter form data ***/ filterForm?.addEventListener('submit', (event)=>{
    event.preventDefault();
    const category = filterForm.querySelector('select').value;
    const maxPrice = filterForm.querySelector('input').value;
    if (category) filteredProducts = (0, _filteringTs.filterCategory)(products, category);
    else filteredProducts = products;
    if (maxPrice) filteredProducts = (0, _filteringTs.filterMaxPrice)(filteredProducts, parseFloat(maxPrice));
    const sortedProducts = (0, _sortingTs.getSortedProducts)(filteredProducts, sortSelect?.value || '');
    (0, _guiTs.renderProducts)(sortedProducts);
});
/*** Sort using sort select ***/ sortSelect?.addEventListener('change', ()=>{
    const sortedProducts = (0, _sortingTs.getSortedProducts)(filteredProducts, sortSelect.value);
    (0, _guiTs.renderProducts)(sortedProducts);
});

},{"./modules/dummyjsonapi.ts":"a5sU2","./modules/gui.ts":"dzzZY","./modules/filtering.ts":"9tnsm","./modules/sorting.ts":"cASZ0"}],"a5sU2":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getAllProducts", ()=>getAllProducts);
var _productTs = require("./Product.ts");
var _productTsDefault = parcelHelpers.interopDefault(_productTs);
const getAllProducts = async ()=>{
    ...
    try {
        ...
        const products = data.products.map((product)=>new (0, _productTsDefault.default)(product));
        return products;
    } catch (error) {
...
},{"./Product.ts":"gZc2O","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gZc2O":[function(require,module,exports,__globalThis) {
/**
...
},{}],"dzzZY":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9tnsm":[function(require,module,exports,__globalThis) {
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cASZ0":[function(require,module,exports,__globalThis) {
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["cg3xG","7ZSs6"], "7ZSs6", "parcelRequire94c2")
